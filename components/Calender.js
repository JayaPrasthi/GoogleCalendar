...
export const Calender = () => {
                ...
                if (dayItems.length !== 0) {
                    response.forEach(res => {
                        ...
                        dayItems.forEach(obj => {
                            // console.log("items of dayItems array:", obj)
                        ...
                        //   console.log(dayValue, res.start_time, res.end_time, res.date, res.Week_Day )
                        ...
                        //   let top
                        //   let left 
                        //  startTimeStampElement.style.position = "relative"
                        //  console.log(startTimeStampElement.id.includes(res.start_time) && endTimeStampElement.id.includes(res.end_time) && startTimeStampElement.id.includes(res.date))

                        //   console.log("starting div element", startTimeStampElement)
                        if (startTimeStampElement && endTimeStampElement) {
                            // console.log("startTime's id:", startTimeStampElement.id)
                            // console.log("end Time's id:", startTimeStampElement.id)
                            for (let i = res.start_time; i <= res.end_time; i++) {
                                // console.log(i)
                                let divCollection = document.getElementById(`day-${dayValue}-time-${i}-date-${res.date}`)
                                // console.log("div", divCollection.offsetHeight)
                                divCollection.style.backgroundColor = "blue"
                                divCollection.style.border = "0px"
                                // totalHeight = totalHeight + divCollection.offsetHeight
                                // top = divCollection.offsetTop
                                // left = divCollection.offsetLeft
                            ...
                            //  absoluteDiv.style.height=totalHeight
                            //   absoluteDiv.style.width="100%"
                            //  absoluteDiv.style.top = top + "px"
                            //  absoluteDiv.style.left = "0"+px
                            //  absoluteDiv.style.position = "absolute"
                            //  absoluteDiv.style.backgroundColor = "blue"
                            //  startTimeStampElement.append(absoluteDiv)
    ...
    const handleClick = (event, machineFormatForDay, machineFormatForTime, date) => {
        //  console.log("array inside the handleClick", ArrayfromSet)
        ...
        // setInitalClickArray(mouseEventArray)
        if (IndividualColumn) {
    ...
    const handleMouseMove = (event) => {
        ...
        // setMouseMoveArray(ArrayfromSet)
...
//            //         IndividualColumn.removeEventListener("mousemove", handleMouseMove)
//            //     }




//            // console.log(lastDiv.parentElement.removeEventListener("mousemove", handleMouseMove))
...
//                // idArray.splice(0, idArray, ...element.id);
...
//                // splitedArr.splice(0,1,splitedValue)
//            })

//            //  console.log(pureNumArr)
...
//    }
    ...
    // console.log("array from set inside the handleClosePopup function ", ArrayfromSet)
